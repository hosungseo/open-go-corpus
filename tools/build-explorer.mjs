...
const notes = [
  ...
  { id: "n_rn_inq", text: `포털 조회수(inqCnt)는 한가운데 사업 기준 2018년 ${vals.rn_inqmed2018}회 → 2025년 ${vals.rn_inqmed2025}회 → 2026년 ${vals.rn_inqmed2026}회. 조회 0 비율 2025년 ${vals.rn_inq0_2025}%, 2026년 ${vals.rn_inq0_2026}%. 상세 페이지 진입 시 올라가는 값이라 내부 확인·봇이 섞일 수 있으나 낮은 쪽으로 편향되지는 않음.`, sample: "전수", date: SNAPSHOT },
